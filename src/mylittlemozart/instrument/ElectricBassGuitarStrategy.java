...
/**
 * Strategy to apply the ElectricBassGuitar instrument to a given MIDI channel.
 * Sends a PROGRAM_CHANGE message at the beginning of the track.
 */
...
public class ElectricBassGuitarStrategy implements InstrumentStrategy{
	 ...
	 * Wraps the message in a MidiEvent with a time stamp of 0 which means it happens at the start of the track
